            ...
            <div class="row pt-5">
                <div class="col-lg-4 col-md-12">
                    <div class="our-services-grid-border">
                        <img src="{{ asset('public/assets/images/about/Corporate Events Icon.svg') }}" alt="" />
                ...
                <div class="swiper-testimonial-main-wrapper" data-sal="slide-up" data-sal-delay="1500"
                    ...
                    <div class="swiper swiper-testimonials-1">
                        <div class="left-quote">
                            <img src="{{ asset('public/assets/images/testimonials/quote-1.webp') }}" alt="testimonial">
                        </div>
                        ...
                        <div class="right-quote">
                            <img src="{{ asset('public/assets/images/testimonials/quote-2.webp') }}" alt="testimonial">
                        </div>
                    </div>
                ...
                <div class="swiper mySwiper-blog">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="blog-wrapper">
                                <div class="image-part">
                                    <img src="{{ asset('public/assets/images/blog/blog-01.jpg') }}" alt="blog">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-wrapper">
                                <div class="image-part">
                                    <img src="{{ asset('public/assets/images/blog/blog-04.jpg') }}" alt="blog">
                                </div>
                                <div class="blog-badge">
                                    <span class="date">12</span>
                                    <span class="month">APR</span>
                        ...
                        <div class="swiper-slide">
                            <div class="blog-wrapper">
                                <div class="image-part">
                                    <img src="{{ asset('public/assets/images/blog/blog-02.jpg') }}" alt="blog">
                                </div>
                                <div class="blog-badge">
                                    <span class="date">12</span>
                                    <span class="month">APR</span>
